...
LRFU combines LRU and LFU policy in that it tracks the frequency and reference for each entry and uses a weighting factor $\lambda$ do decide which is more important.
...
Therefore, LRFU is not suitable as a general cache replacement algorithm.
