...
In addition to \cref{cha:background}, we present current cache replacement strategies aimed at increasing scalability 
and to be used in multi threaded applications.
