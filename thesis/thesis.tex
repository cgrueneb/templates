...
This reference, shown in listing \ref{lst:ObjRef enumeration}, equals to the state of an object at the last access.
...
The incomplete state, as seen in listing \ref{lst:ObjRef enumeration}, can only be reached when an object is deserialized from disk.
