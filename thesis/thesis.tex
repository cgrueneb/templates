...
\begin{table}[ht]
	...
	\caption{The table shows the asymptotic I/O cost for B-tree and $B^{\varepsilon}$-tree.
			...
			child pointers and the space used as message 	buffer.}
...
Additionally, Haura was extended by \cite{hoppner2021design} to include an object storage interface and support for multiple storage levels while retaining the benefits of the $B^{\varepsilon}$-tree.
