...
In order to achieve adaptability, we cannot use a fixed weighting parameter as we have seen with LRFU. 
If the weighting parameter is fixed, we cannot adapt to the access pattern.


But instead of using a fixed parameter to decide which is more important, like LRFU or using a heuristic like ARC or CLOCK-Pro,
ML-CLOCK learns the parameter to weight between recency and frequency from previous decisions.
...
\begin{figure}[ht]
	\includegraphics[scale=0.45]{randread_zipf.jpg}		
	\caption{Random, 100\% read, zipf-distribution}
	\label{fig:randread zipf}
\end{figure}
	
\begin{figure}[ht]
	\includegraphics[scale=0.45]{randread_normal.jpg}		
	\caption{Random, 100\% read, normal-distribution}
	\label{fig:randread normal}
\end{figure}
	
\begin{figure}[ht]
	\includegraphics[scale=0.45]{randread_zoned.jpg}		
	\caption{Random, 100\% read, zoned-distribution}
	\label{fig:randread zoned}
\end{figure}

\begin{figure}[ht]
	\includegraphics[scale=0.45]{randread_uniform.jpg}		
	\caption{Random, 100\% read, uniform-distribution}
...
\begin{figure}[ht]
	\includegraphics[scale=0.45]{rw_90to10_zipf.jpg}		
	\caption{Random, 90\% read, 10\% write, zipf-distribution}
	\label{fig:rw_90to10 zipf}
\end{figure}
	
\begin{figure}[ht]
	\includegraphics[scale=0.45]{rw_90to10_normal.jpg}		
	\caption{Random, 90\% read, 10\% write, normal-distribution}
	\label{fig:rw_90to10 normal}
\end{figure}
	
\begin{figure}[ht]
	\includegraphics[scale=0.45]{rw_90to10_zoned.jpg}		
	\caption{Random, 90\% read, 10\% write, zoned-distribution}
	\label{fig:rw_90to10 zoned}
\end{figure}

\begin{figure}[ht]
	\includegraphics[scale=0.45]{rw_90to10_uniform.jpg}		
	\caption{Random, 90\% read, 10\% write, uniform-distribution}
...
\begin{figure}[ht]
	\includegraphics[scale=0.45]{rw_50to50_zipf.jpg}		
	\caption{Random, 50\% read, 50\% write, zipf-distribution}
	\label{fig:rw_90to10 zipf}
\end{figure}
	
\begin{figure}[ht]
	\includegraphics[scale=0.45]{rw_50to50_normal.jpg}		
	\caption{Random, 50\% read, 50\% write, normal-distribution}
	\label{fig:rw_90to10 normal}
\end{figure}
	
\begin{figure}[ht]
	\includegraphics[scale=0.45]{rw_50to50_zoned.jpg}		
	\caption{Random, 50\% read, 50\% write, zoned-distribution}
	\label{fig:rw_90to10 zoned}
\end{figure}

\begin{figure}[ht]
	\includegraphics[scale=0.45]{rw_50to50_uniform.jpg}		
	\caption{Random, 50\% read, 50\% write, uniform-distribution}
	\label{fig:rw_90to10 uniform}
\end{figure}
